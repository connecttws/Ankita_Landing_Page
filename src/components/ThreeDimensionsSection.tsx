      ...
      <div className="mx-auto max-w-7xl px-3 min-[360px]:px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <button
            ...
            className="inline-flex w-full max-w-[310px] min-[380px]:max-w-[340px] sm:w-auto sm:max-w-none items-center justify-center gap-2 rounded-full bg-primary hover:bg-primary-hover active:scale-98 px-6 py-3.5 sm:px-7 sm:py-3 text-xs sm:text-sm font-bold text-white shadow-lg transition-all cursor-pointer"
          >
