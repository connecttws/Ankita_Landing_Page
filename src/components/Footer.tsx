      ...
      <div className="mx-auto max-w-7xl px-3 min-[360px]:px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-gradient-to-br from-[#032d23] to-[#011a14] rounded-2xl sm:rounded-3xl p-5 min-[360px]:p-7 sm:p-10 border border-[#0d7363]/30 shadow-2xl text-center max-w-3xl mx-auto mb-7 sm:mb-10">
          ...
          <button
            ...
            className="inline-flex w-full max-w-[340px] min-[380px]:max-w-[370px] sm:w-auto sm:max-w-none items-center justify-center gap-2.5 rounded-full bg-primary hover:bg-primary-hover active:scale-98 px-7 sm:px-10 py-4 sm:py-4.5 text-xs min-[360px]:text-sm sm:text-base font-extrabold text-white shadow-xl shadow-emerald-950/30 transition-all cursor-pointer tracking-wide"
          >
